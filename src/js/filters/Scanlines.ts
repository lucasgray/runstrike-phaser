...
export default class Scanlines {
    ...
    fragmentSrc = [
        ...
        "    float distortion = clamp(1.0 - 3.0, 0.0, 1.0);",
    ...
    constructor(game: Phaser.Game) {
        ...
        let filter = new Phaser.Filter(game, null, this.fragmentSrc);
        let s = game.add.sprite();
        s.width = game.width;
        s.height = game.height;
